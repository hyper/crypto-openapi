...
export class WalletsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param expand 
     */
    public async _delete(id: string, prismAccount?: string, expand?: string, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param walletData 
     */
    public async create(prismAccount?: string, walletData?: WalletData, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(walletData, "WalletData", ""),
            contentType
        );
