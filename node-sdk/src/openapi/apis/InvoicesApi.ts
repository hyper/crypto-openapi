...
export class InvoicesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param invoiceData 
     */
    public async create(prismAccount?: string, invoiceData?: InvoiceData, _options?: Configuration): Promise<RequestContext> {
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(invoiceData, "InvoiceData", ""),
            contentType
        );
     ...
     * @param expand Specifies which fields to populate in the response.
     */
    public async poll(id: string, prismAccount?: string, expand?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("InvoicesApi", "poll", "id");
        }
...
export class InvoicesApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async list(response: ResponseContext): Promise<ListInvoicesResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async poll(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return;
        }
