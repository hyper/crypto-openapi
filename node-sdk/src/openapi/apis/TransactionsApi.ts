...
export class TransactionsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async create(prism_account?: string, create_transaction_body?: CreateTransactionBody, _options?: Configuration): Promise<RequestContext> {
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(create_transaction_body, "CreateTransactionBody", ""),
            contentType
        );
    ...
    public async poll(id: string, prism_account?: string, expand?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (id === null || id === undefined) {
            throw new RequiredError("TransactionsApi", "poll", "id");
        }
    ...
    public async retrieve(id: string, prism_account?: string, expand?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("TransactionsApi", "retrieve", "id");
        }
...
export class TransactionsApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async list(response: ResponseContext): Promise<ListTransactionsResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ListTransactionsResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
