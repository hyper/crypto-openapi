...
export class ProductsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async create(prism_account?: string, create_product_body?: CreateProductBody, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(create_product_body, "CreateProductBody", ""),
            contentType
        );
     ...
     */
    public async update(id: string, prism_account?: string, update_product_body?: UpdateProductBody, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(update_product_body, "UpdateProductBody", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
