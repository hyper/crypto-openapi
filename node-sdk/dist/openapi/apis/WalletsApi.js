...
class WalletsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  _delete(walletId, prismAccount, _options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (walletId === null || walletId === undefined) {
        throw new baseapi_1.RequiredError('WalletsApi', '_delete', 'walletId');
      }
  ...
  create(prismAccount, inlineObject4, _options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(
        ObjectSerializer_1.ObjectSerializer.serialize(inlineObject4, 'InlineObject4', ''),
        contentType
      );
  ...
  retrieve(walletId, expand, prismAccount, _options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      let _config = _options || this.configuration;
      if (walletId === null || walletId === undefined) {
        throw new baseapi_1.RequiredError('WalletsApi', 'retrieve', 'walletId');
      }
      const localVarPath = '/wallets/{walletId}'.replace(
        '{' + 'walletId' + '}',
        encodeURIComponent(String(walletId))
  ...
  update(walletId, prismAccount, _options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      let _config = _options || this.configuration;
      if (walletId === null || walletId === undefined) {
        throw new baseapi_1.RequiredError('WalletsApi', 'update', 'walletId');
      }
      const localVarPath = '/wallets/{walletId}'.replace(
        '{' + 'walletId' + '}',
        encodeURIComponent(String(walletId))
