...
class PayoutWalletsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    create(prismAccount, payoutWalletData, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(payoutWalletData, "PayoutWalletData", ""), contentType);
