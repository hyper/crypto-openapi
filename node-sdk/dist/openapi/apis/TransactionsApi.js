...
class TransactionsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    create(prism_account, create_transaction_body, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(create_transaction_body, "CreateTransactionBody", ""), contentType);
    ...
    poll(id, prism_account, expand, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (id === null || id === undefined) {
                throw new baseapi_1.RequiredError("TransactionsApi", "poll", "id");
            }
    ...
    retrieve(id, prism_account, expand, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (id === null || id === undefined) {
                throw new baseapi_1.RequiredError("TransactionsApi", "retrieve", "id");
            }
...
class TransactionsApiResponseProcessor {
    ...
    list(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (util_1.isCodeInRange("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListTransactionsResponse", "");
                return body;
            }
            if (util_1.isCodeInRange("401", response.httpStatusCode)) {
                throw new exception_1.ApiException(response.httpStatusCode, "Unauthorized", undefined, response.headers);
