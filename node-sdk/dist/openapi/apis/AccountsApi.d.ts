...
export declare class AccountsApiRequestFactory extends BaseAPIRequestFactory {
    create(prism_account?: string, create_account_body?: CreateAccountBody, _options?: Configuration): Promise<RequestContext>;
    ...
    update(id: string, prism_account?: string, update_account_body?: UpdateAccountBody, _options?: Configuration): Promise<RequestContext>;
}
