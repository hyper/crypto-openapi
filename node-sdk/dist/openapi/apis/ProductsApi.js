...
class ProductsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  _delete(productId, prismAccount, _options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (productId === null || productId === undefined) {
        throw new baseapi_1.RequiredError('ProductsApi', '_delete', 'productId');
      }
  ...
  create(prismAccount, inlineObject3, _options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(
        ObjectSerializer_1.ObjectSerializer.serialize(inlineObject3, 'InlineObject3', ''),
        contentType
      );
  ...
  retrieve(productId, expand, prismAccount, _options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      let _config = _options || this.configuration;
      if (productId === null || productId === undefined) {
        throw new baseapi_1.RequiredError('ProductsApi', 'retrieve', 'productId');
      }
      const localVarPath = '/products/{productId}'.replace(
        '{' + 'productId' + '}',
        encodeURIComponent(String(productId))
  ...
  update(productId, prismAccount, _options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      let _config = _options || this.configuration;
      if (productId === null || productId === undefined) {
        throw new baseapi_1.RequiredError('ProductsApi', 'update', 'productId');
      }
      const localVarPath = '/products/{productId}'.replace(
        '{' + 'productId' + '}',
        encodeURIComponent(String(productId))
