...
export declare class PaymentLinksApiResponseProcessor {
    _delete(response: ResponseContext): Promise<IPaymentLink>;
    _delete_1(response: ResponseContext): Promise<IPaymentLink>;
    create(response: ResponseContext): Promise<IPaymentLink>;
    create_2(response: ResponseContext): Promise<IPaymentLink>;
    list(response: ResponseContext): Promise<PaymentLinkListResponse>;
    list_3(response: ResponseContext): Promise<PaymentLinkListResponse>;
    retrieve(response: ResponseContext): Promise<IPaymentLink>;
    retrieve_4(response: ResponseContext): Promise<IPaymentLink>;
    update(response: ResponseContext): Promise<IPaymentLink>;
    update_5(response: ResponseContext): Promise<IPaymentLink>;
}
