...
class WebhooksApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    create(prismAccount, inlineObject8, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(inlineObject8, "InlineObject8", ""), contentType);
...
class WebhooksApiResponseProcessor {
    ...
    list(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "InlineResponse2008", "");
                return body;
            }
            if ((0, util_1.isCodeInRange)("404", response.httpStatusCode)) {
                throw new exception_1.ApiException(response.httpStatusCode, "Not Found", undefined, response.headers);
