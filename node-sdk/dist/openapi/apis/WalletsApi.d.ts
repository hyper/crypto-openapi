...
export declare class WalletsApiResponseProcessor {
    _delete(response: ResponseContext): Promise<void | IWallet>;
    _delete_1(response: ResponseContext): Promise<void | IWallet>;
    create(response: ResponseContext): Promise<void | IWallet>;
    create_2(response: ResponseContext): Promise<void | IWallet>;
    list(response: ResponseContext): Promise<void | WalletListResponse>;
    list_3(response: ResponseContext): Promise<void | WalletListResponse>;
    retrieve(response: ResponseContext): Promise<void | IWallet>;
    retrieve_4(response: ResponseContext): Promise<void | IWallet>;
    update(response: ResponseContext): Promise<void | IWallet>;
    update_5(response: ResponseContext): Promise<void | IWallet>;
}
