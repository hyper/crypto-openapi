...
exports.SubscriptionPeriodsApiResponseProcessor = exports.SubscriptionPeriodsApiRequestFactory =
  void 0;
...
class SubscriptionPeriodsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  ...
  retrieve(id, prism_account, expand, _options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const localVarPath = '/subscription_periods/{id}'.replace(
        '{' + 'id' + '}',
  ...
  update(id, prism_account, update_subscription_period_body, _options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(
        ObjectSerializer_1.ObjectSerializer.serialize(
          update_subscription_period_body,
          'UpdateSubscriptionPeriodBody',
          ''
        ),
        contentType
      );
