...
exports.SubscriptionPeriodsApiResponseProcessor = exports.SubscriptionPeriodsApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class SubscriptionPeriodsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    retrieve(id, prism_account, expand, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (id === null || id === undefined) {
                throw new baseapi_1.RequiredError("SubscriptionPeriodsApi", "retrieve", "id");
            }
    ...
    update(id, prism_account, update_subscription_period_body, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (id === null || id === undefined) {
                throw new baseapi_1.RequiredError("SubscriptionPeriodsApi", "update", "id");
            }
            const localVarPath = '/subscription_periods/{id}'
                .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(update_subscription_period_body, "UpdateSubscriptionPeriodBody", ""), contentType);
...
exports.SubscriptionPeriodsApiRequestFactory = SubscriptionPeriodsApiRequestFactory;
class SubscriptionPeriodsApiResponseProcessor {
    list(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (util_1.isCodeInRange("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListSubscriptionPeriodsResponse", "");
                return body;
            }
    ...
    retrieve(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (util_1.isCodeInRange("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "SubscriptionPeriod", "");
                return body;
            }
            if (util_1.isCodeInRange("401", response.httpStatusCode)) {
                throw new exception_1.ApiException(response.httpStatusCode, "Unauthorized", undefined, response.headers);
...
exports.SubscriptionPeriodsApiResponseProcessor = SubscriptionPeriodsApiResponseProcessor;
//# sourceMappingURL=SubscriptionPeriodsApi.js.map