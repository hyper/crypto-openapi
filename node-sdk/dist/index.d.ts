...
declare class SubscriptionsApiLayer {
    ...
    cancel(id: string, params: Omit<SubscriptionsApiCancelRequest, 'prism_account'>, options?: {
        prismAccount: string;
    }): Promise<Subscription>;
}
declare class PaymentIntentsApiLayer {
    ...
    poll(id: string, params?: Omit<PaymentIntentsApiPollRequest, 'prism_account' | 'id'>, options?: {
        prismAccount: string;
    }): Promise<PaymentIntent>;
    cancel(id: string, params: Omit<PaymentIntentsApiCancelRequest, 'prism_account'>, options?: {
        prismAccount: string;
    }): Promise<PaymentIntent>;
}
