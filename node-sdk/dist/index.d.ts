...
declare class CustomersApiLayer {
    ...
    retrieve(customerId: string, params?: Omit<CustomersApiRetrieveRequest, 'prismAccount' | 'customerId'>, options?: {
        prismAccount: string;
    }): Promise<Customer>;
    update(customerId: string, data: Omit<CustomersApiUpdateRequest, 'prismAccount' | 'customerId'>, options?: {
        prismAccount: string;
    }): Promise<Customer>;
...
declare class FeesApiLayer {
    ...
    retrieve(feeId: string, params?: Omit<FeesApiRetrieveRequest, 'prismAccount' | 'feeId'>, options?: {
        prismAccount: string;
    }): Promise<Fee>;
...
declare class InvoicesApiLayer {
    ...
    retrieve(invoiceId: string, params?: Omit<InvoicesApiRetrieveRequest, 'prismAccount' | 'invoiceId'>, options?: {
        prismAccount: string;
    }): Promise<Invoice>;
    update(invoiceId: string, data: Omit<InvoicesApiUpdateRequest, 'prismAccount' | 'invoiceId'>, options?: {
        prismAccount: string;
    }): Promise<Invoice>;
...
declare class LogsApiLayer {
    private readonly api;
    constructor(config: Configuration);
    retrieve(logId: string, params?: Omit<LogsApiRetrieveRequest, 'prismAccount' | 'logId'>, options?: {
        prismAccount: string;
    }): Promise<Log>;
...
declare class PaymentsApiLayer {
    private readonly api;
    constructor(config: Configuration);
    retrieve(paymentId: string, params?: Omit<PaymentsApiRetrieveRequest, 'prismAccount' | 'paymentId'>, options?: {
        prismAccount: string;
    }): Promise<Payment>;
...
declare class ProductsApiLayer {
    private readonly api;
    constructor(config: Configuration);
    create(data: ProductsApiCreateRequest['inlineObject3'], options?: {
        prismAccount: string;
    }): Promise<Product>;
    retrieve(productId: string, params?: Omit<ProductsApiRetrieveRequest, 'prismAccount' | 'productId'>, options?: {
        prismAccount: string;
    }): Promise<Product>;
    update(productId: string, data: Omit<ProductsApiUpdateRequest, 'prismAccount' | 'productId'>, options?: {
        prismAccount: string;
    }): Promise<Product>;
...
declare class WalletsApiLayer {
    private readonly api;
    constructor(config: Configuration);
    create(data: WalletsApiCreateRequest['inlineObject4'], options?: {
        prismAccount: string;
    }): Promise<Wallet>;
    retrieve(walletId: string, params?: Omit<WalletsApiRetrieveRequest, 'prismAccount' | 'walletId'>, options?: {
        prismAccount: string;
    }): Promise<Wallet>;
    update(walletId: string, data: Omit<WalletsApiUpdateRequest, 'prismAccount' | 'walletId'>, options?: {
        prismAccount: string;
    }): Promise<Wallet>;
...
declare class WebhooksApiLayer {
    private readonly api;
    constructor(config: Configuration);
    create(data: WebhooksApiCreateRequest['inlineObject5'], options?: {
        prismAccount: string;
    }): Promise<Customer>;
    retrieve(webhookId: string, params?: Omit<WebhooksApiRetrieveRequest, 'prismAccount' | 'webhookId'>, options?: {
        prismAccount: string;
    }): Promise<Customer>;
    update(webhookId: string, data: Omit<WebhooksApiUpdateRequest, 'prismAccount' | 'webhookId'>, options?: {
        prismAccount: string;
    }): Promise<Customer>;
