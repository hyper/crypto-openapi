...
export declare class WebhooksApiRequestFactory extends BaseAPIRequestFactory {
    _delete(webhookId: string, prismAccount?: string, _options?: Configuration): Promise<RequestContext>;
    ...
    retrieve(webhookId: string, expand?: string, prismAccount?: string, _options?: Configuration): Promise<RequestContext>;
    update(webhookId: string, prismAccount?: string, _options?: Configuration): Promise<RequestContext>;
}
