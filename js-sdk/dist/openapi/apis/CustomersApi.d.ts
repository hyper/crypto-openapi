...
export declare class CustomersApiRequestFactory extends BaseAPIRequestFactory {
    create(inlineObject?: InlineObject, _options?: Configuration): Promise<RequestContext>;
    list(limit?: number, page?: number, sort?: any, expand?: string, _options?: Configuration): Promise<RequestContext>;
    retrieve(customerId: string, _options?: Configuration): Promise<RequestContext>;
    update(customerId: string, _options?: Configuration): Promise<RequestContext>;
}
