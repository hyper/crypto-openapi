...
export declare class FeesApiRequestFactory extends BaseAPIRequestFactory {
    _delete(feeId: string, _options?: Configuration): Promise<RequestContext>;
    create(inlineObject1?: InlineObject1, _options?: Configuration): Promise<RequestContext>;
    list(limit?: number, page?: number, sort?: any, expand?: string, _options?: Configuration): Promise<RequestContext>;
    retrieve(feeId: string, _options?: Configuration): Promise<RequestContext>;
}
