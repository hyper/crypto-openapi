    ...
    retrieve(paymentId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (paymentId === null || paymentId === undefined) {
                throw new baseapi_1.RequiredError("PaymentsApi", "retrieve", "paymentId");
            }
...
class PaymentsApiResponseProcessor {
    list(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "InlineResponse20011", "");
                return body;
            }
    ...
    retrieve(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "InlineResponse20012", "");
                return body;
            }
