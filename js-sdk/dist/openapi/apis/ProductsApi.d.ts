...
export declare class ProductsApiRequestFactory extends BaseAPIRequestFactory {
    _delete(productId: string, _options?: Configuration): Promise<RequestContext>;
    create(inlineObject3?: InlineObject3, _options?: Configuration): Promise<RequestContext>;
    list(limit?: number, page?: number, sort?: any, expand?: string, _options?: Configuration): Promise<RequestContext>;
    retrieve(productId: string, _options?: Configuration): Promise<RequestContext>;
    update(productId: string, _options?: Configuration): Promise<RequestContext>;
}
