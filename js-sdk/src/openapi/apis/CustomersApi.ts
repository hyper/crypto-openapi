...
export class CustomersApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param inlineObject 
     */
    public async create(inlineObject?: InlineObject, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param customerId 
     */
    public async retrieve(customerId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param customerId 
     */
    public async update(customerId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class CustomersApiResponseProcessor {
     ...
     */
     public async create(response: ResponseContext): Promise<InlineResponse2001 > {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async retrieve(response: ResponseContext): Promise<InlineResponse2001 > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: InlineResponse2001 = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async update(response: ResponseContext): Promise<InlineResponse2002 > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
